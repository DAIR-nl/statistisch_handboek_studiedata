...
H~0~: Het gemiddelde eindexamencijfer voor de exacte vakken van de VWO studenten die beginnen aan de Bachelor Werktuigbouwkunde is hoger dan of gelijk aan het landelijk gemiddelde, µ >= . 

H~A~: Het gemiddelde eindexamencijfer voor de exacte vakken van de VWO studenten die beginnen aan de Bachelor Werktuigbouwkunde is lager dan het landelijk gemiddelde, µ < . 
...
## Uitvoering in R
Voor de uitvoering in R is er een dummydataset genaamd gemiddeld_cijfer_wns ingeladen met gemiddelde cijfers in Wiskunde A van 165 middelbare scholieren.

...
* Gemiddeld tentamencijfer voor tutorgesprek (standaardafwijking): `r vMeant0` (`r vSDt0`). *n* = `r vNt0`.
* Gemiddeld tentamencijfer na tutorgesprek (standaardafwijking): `r vMeant1` (`r vSDt1`). *n* = `r vNt1`.

...
De opleidingsdirecteur van de lerarenopleiding vraagt zich af of de studenten, nadat ze met hun tutor hebben gesproken, de lerarenopleiding een ander cijfer geven. Ze vraagt of de studenten een vragenlijst in willeb vullen (T~0~) en nog een keer nadat de studenten naar hun tutor geweest zijn (T~1~). 
...
Beide histogrammen laten een belvorm zien vergelijkbaar aan een normale verdeling, veel waardes liggen rondom het gemiddelde. Het histogram "wel een tutor" lijkt iets scheef verdeeld. Voer de *Kolmogorov-Smirnov test* of de *Shapiro-Wilk test* uit om te toetsen of de histogrammen normaal verdeeld zijn.  
...
De *Shapiro-Wilk test* wordt vooral gebruikt bij kleine steekproeven, maar kan ook bij grotere streekproeven. Ook bij deze toets geldt dat wanneer de p-waarde groter is dan 0,05 is de verdeling van de data niet significant verschillend van de normale verdeling.  

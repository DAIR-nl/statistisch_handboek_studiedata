...
```
*n* = `r length(Tentamencijfer_voor_tutorgesprek)`   
Gemiddeld tentamencijfer voor tutorgesprek (standaardafwijking): `r vMeant0` (`r vSDt0`)
...
```
*n* = `r length(Tentamencijfer_na_tutorgesprek)`   
Gemiddeld tentamencijfer voor tutorgesprek (standaardafwijking): `r vMeant1` (`r vSDt1`)
</div>

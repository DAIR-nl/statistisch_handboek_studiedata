...
Tevredenheidscijfer_na_tutorgesprek <- Tevredenheidscijfer_na_tutorgesprek[Tevredenheidscijfer_na_tutorgesprek <= 10 
...
Tevredenheidscijfer_voor_tutorgesprek <- Tevredenheidscijfer_voor_tutorgesprek[Tevredenheidscijfer_voor_tutorgesprek <= 10 
...
Tevredenheidscijfer_voor_tutorgesprek_n30 <- Tevredenheidscijfer_voor_tutorgesprek_n30[Tevredenheidscijfer_voor_tutorgesprek_n30 <= 10 
...
Tevredenheidscijfer_na_tutorgesprek_n30 <- Tevredenheidscijfer_na_tutorgesprek_n30[Tevredenheidscijfer_na_tutorgesprek_n30 <= 10 
...
<div class ="col2">
```{r qqplot voor tutor}
qqnorm(Tevredenheidscijfer_voor_tutorgesprek , pch = 1)
qqline(Tevredenheidscijfer_voor_tutorgesprek)
```

```{r qqplot na tutor}
qqnorm(Tevredenheidscijfer_na_tutorgesprek, pch = 1)
qqline(Tevredenheidscijfer_na_tutorgesprek)
```
</div>
Als over het algemeen de meeste datapunten op de lijn liggen, kan aangenomen worden dat de data normaal verdeeld is. In deze casus liggen .... 
...
[^2]: Van Geloven, N. (25 september 2013). Matchen [Wiki Statistiek Academisch Medisch Centrum]. https://wikistatistiek.amc.nl/index.php/Matchen

...
Beide histogrammen laten een belvorm zien vergelijkbaar aan een normaalverdeling, veel waardes liggen rondom het gemiddelde. Het histogram "wel een tutor" lijkt scheef verdeelt. Voer de *Kolmogorov-Smirnov test* of de *Shapiro-Wilk test* uit om te toetsen of de histogrammen normaal verdeeld zijn.  
...
```
#t (247) = -2.7787, p < 0.01  
# Vrijheidsgraden: df = n~1~ + n~2~  - 2 = 247  

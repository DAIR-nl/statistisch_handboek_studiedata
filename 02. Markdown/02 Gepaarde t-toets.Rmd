...
```
* *t* (247) = 17,997, *p* < 0,01  
* Vrijheidsgraden: *df* = *n* -1 = 245 
* p-waarde < 0,05, dus de H~A~ wordt aangenomen  
* 95%-betrouwbaarheidsinterval: het interval loopt tussen 0,25 en de 0.32
* Het verschil tussen beide groepen is 0,29
...
#### Eta-squared
```{r eta-squared}
#ik heb geen optie gevonden die etasq uitrekent zonder anova.
t <- 17.713
df <- 245
Eta2 <- (t^2) / (t^2 + 245)
Eta2
```
##### Dit is een titel die werkt in een tab
...
[^5]: Eta-squared. (2019 May 14). Retrieved from: https://en.wikiversity.org/wiki/Eta-squared 
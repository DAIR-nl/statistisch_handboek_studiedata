...
<div class="col2">
```{r test}
Evaluatie_score_geen_tutor
Evaluatie_score_geen_tutor_n30
Evaluatie_score_wel_tutor
Evaluatie_score_wel_tutor_n30
```
</div>
## Gebruik
...
Wanneer uit bovenstaande tests blijkt dat de data niet normaal verdeeld is, kan de *t-toets* niet gebruikt worden.
...
[^3]: E Marshall, E Boggis - Statstutor Community Project, 2016 - statstutor.ac.uk The Statistics Tutor’s  Quick Guide to Commonly Used Statistical Tests  - Ellen Marshall, University of Sheffield 

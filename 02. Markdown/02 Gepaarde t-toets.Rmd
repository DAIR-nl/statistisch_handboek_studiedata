...
Gemiddeld tentamencijfer na tutorgesprek (standaardafwijking): 7,04 (1,43)
...
Beide histogrammen laten een belcurve zien vergelijkbaar aan een normale verdeling. Veel waardes liggen rondom de gemiddeldes. Opvallend is dat het histogram `Tentamencijfer_voor_tutorgesprek` veel waardes in de linker staart van de verdeling heeft liggen.  
...
De boxplotten geven de spreiding van het gemiddelde tentamencijfer per periode weer voor de lerarenopleiding. De boxplot en de staarten van T~0~ zijn niet helemaal symmetrisch. Dit kan een teken zijn dat de data niet normaal verdeeld is. Het gaat om een kleine afwijking, daarom is de data vermoedelijk normaal verdeeld. Er zijn geen uitbijters. De boxplot van T~1~ ziet er symmetrisch uit.    

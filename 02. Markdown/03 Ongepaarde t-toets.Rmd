...
Wanneer uit bovenstaande tests blijkt dat de steekproef niet normaal verdeeld is, kan de t-toets niet gebruikt worden, maar wel de *Mann-Whitney U toets*, ook bekend als de *Wilcoxon rank-sum toets* [^1].  
...
sd(Cijfers_2011)
```
gemiddelde 2011 (standaarddeviatie): 6,61(1,2) 
</div>

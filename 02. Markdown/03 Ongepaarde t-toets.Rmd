...
Toets met de *Levene’s Test (for equality of variance)* of de spreiding van iedere groep ongeveer hetzelfde is. Bij een *p* < 0,05 is de spreiding van de groepen statistisch significant verschillend.[^6]
...
vF_p <- Round_and_format(L$`Pr(>F)`[2])

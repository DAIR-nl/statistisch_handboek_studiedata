...
Jaartal <- c(replicate(180, 2010), replicate(160, 2011))
Cijfers_verbetering <- data.frame(Cijfers, Jaartal)
...
library(car)
leveneTest(Cijfers_verbetering$Cijfers, Cijfers_verbetering$Jaartal)
```
### Ongepaarde t-toets

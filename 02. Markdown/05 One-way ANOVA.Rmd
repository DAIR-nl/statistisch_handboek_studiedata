...
```
<!-- ## /BLOK: Data-beschrijven-1.R -->
```{r Var beschrijven 1, include=FALSE, echo=TRUE}
vMean_ATC <- Round_and_format(mean(Reistijd_ATC))
...
```
<!-- ## /BLOK: Data-beschrijven-2.R -->
```{r Var beschrijven 2, include=FALSE, echo=TRUE}
vMean_FIL <- Round_and_format(mean(Reistijd_FIL))
...
```
<!-- ## /BLOK: Data-beschrijven-3.R -->
```{r Var beschrijven 3, include=FALSE, echo=TRUE}
vMean_GSC <- Round_and_format(mean(Reistijd_GSC))
vSD_GSC <-Round_and_format(sd(Reistijd_GSC))
vN_GSC <- Round_and_format(length(Reistijd_GSC))
```
</div>

* Gemiddelde reistijd Arabische Taal en Cultuur (standaarddeviatie): `r vMean_ATC` (`r vSD_ATC`). n = `r vN_ATC`  
* Gemiddelde reistijd Filosofie (standaarddeviatie): `r vMean_FIL` (`r vSD_FIL`). n = `r vN_FIL`.
* Gemiddelde reistijd Geschiedenis (standaarddeviatie): `r vMean_GSC` (`r vSD_GSC`). n = `r vN_GSC   `.

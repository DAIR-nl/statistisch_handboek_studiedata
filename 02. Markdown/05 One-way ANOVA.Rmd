...
## 5 Uitvoering in R
Er is een dummy dataset met de reistijden van uitwonende studenten per opleiding is ingeladen genaamd `Reistijd_per_opleiding`. 

...
Geen_ls_uitval_n43 <- c(8, 14)
Wel_ls_uitval_n43 <- c(5, 16)
Uitval_functiebeperking_n43 <- t(data.frame(Geen_ls_uitval_n43, Wel_ls_uitval_n43))
...
De studieadviseur van de opleiding filosofie vraagt zich af of de studenten met een functiebeperking vaker uitvallen sinds de invoering van het leenstelsel?
...
p-waarde > 0,05 , dus de H~0~ wordt aangenomen  
De odds op het uitvallen van studenten met een functiebeperking onder het leenstelsel is 1,8 keer zo groot als de odds op het uitvallen van studenten met een functiebeperking voor leenstelsel. Deze associatie blijkt niet significant te zijn: p < 0,51  

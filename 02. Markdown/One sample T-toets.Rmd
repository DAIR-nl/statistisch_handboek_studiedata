...
H~0~: Het gemiddelde eindexamencijfer voor de exacte vakken van de VWO studenten die beginnen aan de Bachelor Werktuigbouwkunde is hoger dan of gelijk aan het landelijkge gemiddelde, µ >= . 

H~A~: Het gemiddelde eindexamencijfer voor de exacte vakken van de VWO studenten die beginnen aan de Bachelor Werktuigbouwkunde is lager dan het landelijkge gemiddelde, µ < . 
...
Toets normaliteit met de The Kolmogorov-Smirnov Test of met de The Shapiro-Wilk Test (n < 30). 

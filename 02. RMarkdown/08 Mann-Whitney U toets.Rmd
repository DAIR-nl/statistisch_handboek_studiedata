...
<!-- ## /BLOK: Data-aanmaken.R -->
# Toepassing
Gebruik de *Mann-Whitney U toets* om te toetsen of twee onafhankelijke [^4]groepen aan elkaar gelijk zijn. Deze toets wordt ook Mann–Whitney–Wilcoxon, Wilcoxon rank-sum toets, of Wilcoxon–Mann–Whitney toets genoemd.[^1]
...
H~0~: Het behaalde aantal EC in het tweede jaar is hetzelfde van internationale studenten als van de Nederlandse studenten. 

H~1~: Het behaalde aantal EC in het tweede jaar is anders van internationale studenten als van de Nederlandse studenten.

...
De *Kruskal Wallis toets* is een alternatief voor de *one way ANOVA*.[^1] De *Kruskal Wallis toets* ordent de scores van laag naar hoog en geeft de scores een rangnummer. Op deze wijze zijn outliers, de assumptie van normaliteit en/of van homogeniteit van varianties geen probleem meer.[^2]  
...
<!-- ## /BLOK: Mann-Whitney-U-test-->
# Rapportage
De *kruskal Wallis toets* is uitgevoerd om te toetsen of een vooropleiding bepalend is voor de  hoeveelheid studiepunten die een student behaalt tijdens het eerste jaar van de master Arbeidsrecht. Uit de resultaten kan afgelezen worden dat er een statistisch significant verschil is tussen het aantal studiepunten en het type vooropleiding die de student heeft afgerond. χ^2^ (df) ≈ `r vK_Chi2` (`r vK_DF`), `r vK_P` < 0,01.  
Met een post-hoc toets is het verschil tussen de vooropleidingen getoets. 



[^1]: van Geloven, N. (21 maart 2018). *Kruskal Wallis* https://wikistatistiek.amc.nl/index.php/Kruskal_Wallis 
[^2]: Universiteit van Amsterdam (7 juli 2014). *Kruskal-Wallis Test* https://wiki.uva.nl/methodologiewinkel/index.php/Kruskal-Wallis_Test 

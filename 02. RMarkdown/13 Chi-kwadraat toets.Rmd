...
## Chi-kwadraat toets
De *chi-kwadraat toets* wordt uitgevoerd om de vraag te beantwoorden of de verhouding uitval van het aantal studenten met een functiebeperking na de invoering van het leenstelsel gelijk is gebleven.  
...
Er is een dataset ingeladen `Uitval_functiebeperking_n43`, alle groepen hebben een laag aantal per cel, variërend van 5 tot 16.

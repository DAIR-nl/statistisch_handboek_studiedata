...
# Onderwijscasus
De studentendecaan vraagt zich af of de frequentie studenten met een functiebeperking gelijk is gebleven sinds de invoering van het leenstelsel.
...
H~A~: De verhouding uitval van het aantal studenten met een functiebeperking en zonder een functiebeperking is na de invoering van het leenstelsel is veranderd.
...
* Het 95% betrouwbaarheidsinterval: het interval is van `r vConf.int1` en de `r vConf.int2`.   

...
De verwachting is dat de studenten hoger scoren, maar omdat het relevant om te weten of de studenten ook lager scoren dan het landelijk gemiddelde is er voor gekozen om tweezijdig te toetsen. Gebruik de hele dataset `dfGemiddeld_cijfer_WNS` met *n* = `r py$N`.
<!-- ## /TEKSTBLOK: T-test.py -->

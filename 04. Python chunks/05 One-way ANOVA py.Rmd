...
De standaard interpretatie van een statitische toets in Python is als volgt: `(<teststatistiek>, <p-waarde>)`. Verder wordt er als standaard ook tweezijdig getoetst.
<!-- ## /TEKSTBLOK: Lilliefors-test1.py -->

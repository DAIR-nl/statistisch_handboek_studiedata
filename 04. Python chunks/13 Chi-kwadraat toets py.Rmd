...
Er is een dataset ingeladen over de uitval van studenten met een functiebeperking voor en na de invoering van het leenstelsel. De data `dfUitval_functiebeperking` zijn binair: wel of geen uitval. 
<!-- ## /TEKSTBLOK: Dataset-inladen.R-->

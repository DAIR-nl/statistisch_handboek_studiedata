...
Prop_BSA_antropologie_kruistabel = pd.crosstab(dfBSA_antropologie['BSA'], dfBSA_antropologie['Landen_vooropleiding'], normalize = 'index')
...
```{python}
# Bereken de residuen 
Residuen = sms.contingency_tables.Table(BSA_antropologie_kruistabel).resid_pearson
...
* Significant hoger aantal observaties bij negatief BSA Spanje (ES), *z* = `r Round_and_format(py$Residuen[1,"ES"])`

...
dfToetsen <- tribble(
    ...
    "08 Mann-Whitney U toets I",                                                                "0", 
    "09 Friedmans ANOVA I",                                                                     "0", 
    "10 Kruskal Wallis toets I",                                                                "0", 
    "11 Chi-kwadraat toets voor goodness of fit en binomiaaltoets",                             "0", 
    "12 McNemar toets I",                                                                       "0", 
    "13 Chi-kwadraat toets voor onafhankelijkheid en Fishers exact toets",                      "0", 
    ...
    "21 Chi-kwadraat toets voor onafhankelijkheid en Fisher-Freeman-Halton exact toets III",    "0",     

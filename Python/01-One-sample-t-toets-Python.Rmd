...
De p-waarde is `r Round_and_format(py$lillieforstest[2])`, dus er is geen statistisch significant verschil gevonden tussen de verdeling van de steekproef en de normale verdeling. De *one sample-t-toets* kan uitgevoerd worden.
<!-- ## /TEKSTBLOK: Lilliefors-test2.py -->
...
De p-waarde is `r Round_and_format(py$swtest[2])`, dus er is geen statistisch significant verschil gevonden tussen de verdeling van de steekproef en de normale verdeling. De *one sample-t-toets* kan uitgevoerd worden.
<!-- ## /TEKSTBLOK: Shapiro-Wilk-test2.py -->

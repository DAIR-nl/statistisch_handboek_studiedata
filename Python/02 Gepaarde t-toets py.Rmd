...
plt.title("voor")
plt.hist(Tentamencijfer_voor_tutorgesprek, density = True, edgecolor = "black", bins = 9)

fig.add_subplot(1, 2, 2)
plt.title("na")
plt.hist(Tentamencijfer_na_tutorgesprek, density = True, edgecolor = "black", bins = 9)

fig.suptitle('Lerarenopleiding tentamencijfers')
plt.show()
```
<!-- ## /BLOK: Histogram.R -->
...
stats.probplot(Tentamencijfer_voor_tutorgesprek, dist="norm", plot=plt)
plt.title("Normaal Q-Q plot van tentamencijfers voor tutorgesprek")
...
<!-- ## BLOK: QQplot-2.py -->
```{python qqplot-2}
stats.probplot(Tentamencijfer_na_tutorgesprek, dist="norm", plot=plt)
plt.title("Normaal Q-Q plot van tentamencijfers na tutorgesprek")
plt.xlabel("Theoretische kwantielen")
plt.ylabel("Kwantielen in data")
plt.show()
```
...
## Boxplot
fig, ax = plt.subplots()
ax.boxplot([Tentamencijfer_voor_tutorgesprek, Tentamencijfer_na_tutorgesprek], labels = ["Voor", "Na"])
plt.title("Boxplot van tentamencijfers lerarenopleiding")
plt.show()
```
<!-- ## /BLOK: Boxplot.R -->

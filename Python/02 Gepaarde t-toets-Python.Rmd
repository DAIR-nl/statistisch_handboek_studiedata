...
## Normaliteit
De *t-toets* gaat ervan uit dat de verschillen tussen de gepaarde observaties normaal verdeeld zijn. Ga er bij een aantal observatie-eenheden *n* > 100 vanuit dat de *t-toets* robuust genoeg is om uit te voeren zonder dat de data een normale verdeling volgt.[^2]   

Controleer de assumptie van normaliteit met de volgende stappen:  
1. Controleer de data visueel met een histogram, een Q-Q plot en een boxplot.  
...
Als blijkt dat de data niet normaal verdeeld is, transformeer dan de data eventueel en bepaal daarna of deze wel normaal verdeeld is [^5] of gebruik de [Wilcoxon signed rank toets](07-Wilcoxon-signed-rank-toets-R.html).[^6]<sup>, </sup>[^7]
...
### Shapiro-Wilk Test
De *Shapiro-Wilk test* is een soortgelijke test als de *Kolmogorov-Smirnov test* en vooral geschikt bij kleine steekproeven (*n* < 50). Als de p-waarde kleiner dan 0,05 is, is de verdeling van de data significant verschillend van de normale verdeling.
...
[^5]: Bereken de logaritme van de variabele en de inverse (1 gedeeld door de variabele), en bekijk of deze normaal verdeeld is. Als dat zo is, mag je die gebruiken voor de analyse.

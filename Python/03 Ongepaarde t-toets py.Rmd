...
plt.title("2010")
plt.hist(Cijfers_2010, density = True, edgecolor = "black", bins = 9)

fig.add_subplot(1, 2, 2)
plt.title("2011")
plt.hist(Cijfers_2011, density = True, edgecolor = "black", bins = 9)

fig.suptitle('Taalwetenschap gemiddelde cijfers voor en na de BSA')
plt.show()
```
<!-- ## /BLOK: Histogram.R -->
...
stats.probplot(Cijfers_2010, dist="norm", plot=plt)
plt.title("Normaal Q-Q plot van tentamencijfers 2010")
...
```{python QQplot-t2}
import scipy.stats as stats
stats.probplot(Cijfers_2011, dist="norm", plot=plt)
plt.title("Normaal Q-Q plot van tentamencijfers 2011")
plt.xlabel("Theoretische kwantielen")
plt.ylabel("Kwantielen in data")
plt.show()
```
...
```{python boxplot}
fig, ax = plt.subplots()
ax.boxplot([Cijfers_2010, Cijfers_2011], labels = ["2010", "2011"])
plt.title("Tentamencijfers Taalwetenschap voor en na de BSA")
plt.show()
```
<!-- ## /BLOK: Boxplot.R -->
...
```{python Levenes test, message=FALSE, warning=FALSE, collapse=TRUE}
print(stats.levene(dfCijfers_gem["Cijfers"], dfCijfers_gem["Cohort"]))
```
...
print(stats.ttest_ind(dfCijfers_gem["Cijfers"], dfCijfers_gem["Cohort"]))
```
<!-- ## /BLOK: T-test.R -->

...
<!-- ## BLOK: Data-beschrijven-inladen.py -->
```{python}
...
<!-- ## BLOK: Levenes-test.R -->
```{python Levenes test}
print(stats.levene(dfReistijd_per_opleiding['Reistijd'], dfReistijd_per_opleiding['Opleiding']))
```
...
Gebruik `stats.f_oneway()` om een ANOVA-test uit te voeren.
<!-- ## BLOK: ANOVA-toets.R -->
```{python ANOVA}
print(stats.f_oneway(dfReistijd_per_opleiding['Reistijd'], dfReistijd_per_opleiding['Opleiding']))
```
<!-- ## /BLOK: ANOVA-toets.R -->

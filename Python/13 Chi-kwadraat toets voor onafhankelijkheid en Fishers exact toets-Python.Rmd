...
# Sla vier waarden apart op
fgg = np.array(Prop_Uitval_studenten_kruistabel)[0,0]
fgu = np.array(Prop_Uitval_studenten_kruistabel)[0,1]
fwg = np.array(Prop_Uitval_studenten_kruistabel)[1,0]
fwu = np.array(Prop_Uitval_studenten_kruistabel)[1,1]
```
<!-- ## /CLOSEDBLOK: Rapportage1Fisher.py -->

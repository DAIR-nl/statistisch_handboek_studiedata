...
## Normaliteit 
De *ongepaarde t-toets* gaat ervan uit dat de afhankelijke variabele normaal verdeeld is voor alle groepen. Ga er bij een aantal observaties *n* > 100 in een groep ervanuit dat de *ongepaarde t-toets* voor die groep robuust genoeg is om uit te voeren zonder dat de afhankelijke variabele een normale verdeling volgt.[^2] 

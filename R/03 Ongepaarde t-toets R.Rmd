...
## Ongepaarde t-toets
<!-- ## TEKSTBLOK: T-test.R -->
Voer een ongepaarde `t.test()` uit met `paired = FALSE` en `var.equal = TRUE`. Als uit de *Levene's test* komt dat de groepen verschillen in variantie, gebruik `var.equal = FALSE`. Het eerste argument bestaat uit de afhankelijke variabele `Cijfers` en de groepvariabele `Cohort`.
<!-- ## /TEKSTBLOK: T-test.R -->

...
```{r Data beschrijven 1, eval = FALSE}
...
De opleidingen Geschiedenis en Arabische taal en Cultuur zijn niet geheel symmetrisch, maar tonen geen grote afwijkingen van een normale verdeling. Filosofie heeft een lagere frequentie bij een reistijd van 40 minuten, wat kan duiden op niet normaal verdeelde data. 

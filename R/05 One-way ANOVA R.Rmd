...
# Toepassing
Gebruik de *one-way ANOVA* bij het toetsen of het gemiddelde van drie of meer onafhankelijke groepen verschillen.[^1] 
...
# Effectmaat
De p-waarde geeft aan of het verschil tussen twee groepen statistisch significant is. Bereken de effectmaat om te bepalen of het gevonden verschil betekenisvol is. Hier worden twee effectmaten besproken die veel voorkomen: Cohen's *f* en eta squared.   

## Cohen's f
Cohen's *f* geeft de sterkte van het effect van een onafhankelijke variabele, de opleiding, op een afhankelijke variabele, de reistijd, weer. Een indicatie om *f* te interpreteren is: rond 0,10 is een klein effect, rond 0,25 is een gemiddeld effect en rond 0,40 is een groot effect.[^10]

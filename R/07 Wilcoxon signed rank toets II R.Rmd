...
# Toepassing
Gebruik de *Wilcoxon signed rank toets* om te toetsen of de verdelingen van twee gepaarde groepen van elkaar verschillen.[^1] Deze toets is een alternatief voor de [gepaarde t-toets](02-Gepaarde-t-toets-R.html) wanneer de verschilscores van de gepaarde groepen niet normaal verdeeld zijn. Wanneer de verdeling van de verschilscores symmetrisch is, kan de *Wilcoxon signed rank toets* gebruikt worden om een verschil tussen de medianen van gepaarde groepen te toetsen. Gebruik de gepaarde tekentoets om medianen te toetsen wanneer de verdeling van verschilscores niet symmetrisch is.

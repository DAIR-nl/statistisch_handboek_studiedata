...
Datum <- c(replicate(length(Alumni_inkomens_t1), "t1"), (replicate(length(Alumni_inkomens_t2), "t2")))
...
Alumni_inkomens_t2 <- Alumni_inkomens$Inkomen[Alumni_inkomens$Datum == "t2"]
```
...
<!-- ## CLOSEDBLOK: Data-beschrijven-2.R -->
<!-- ## TEKSTBLOK: Data-beschrijven.R-->
* Mediaan inkomens op T~1~: , *n~T1~* = `r vMed_t1`
* Mediaan inkomens op T~2~: , *n~t2~* = `r vMed_t2`

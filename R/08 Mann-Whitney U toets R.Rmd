...
Gebruik `wilcox.test()` om een Mann-Whitney U toets te doen. Het eerste argument bevat het aantal studiepunten van Nederlandse studenten `Punten_jaar2$EC_Jaar2[Nederlands]`; het tweede argument het aantal studiepunten van internationale studenten `Punten_jaar2$EC_Jaar2[!Nederlands]`.
<!-- ## /TEKSTBLOK: Mann-Whitney-U-toets-1.R -->

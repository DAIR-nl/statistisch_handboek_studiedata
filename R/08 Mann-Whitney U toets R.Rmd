...
Bereken de effectmaat *r* vervolgens op basis van de *p*-waarde van de *Mann-Whitney U toets*.
```{r effectgrootte}
# Sla p-waarde op
...
* Effectmaat is `r Round_and_format(r)`, dus een klein tot gemiddeld effect

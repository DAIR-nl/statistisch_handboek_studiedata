...
<!-- ## /BLOK: Data-aanmaken.R -->
# Toepassing
Gebruik de *Mann-Whitney U toets* om te toetsen of twee groepen significant van elkaar verschillen. 

Deze toets wordt ook *Mann–Whitney–Wilcoxon*, *Wilcoxon rank-sum toets*, of *Wilcoxon–Mann–Whitney toets* genoemd.[^1] 

De *Mann-Whitney U toets* kan een alternatief zijn voor de *ongepaarde t-toets*. De *Mann-Whitney U toets* is verdelingsvrij, hierdoor is normaliteit geen assumptie voor de toets. Bij *Mann-Whitney U toets* hebben uitbijters minder invloed op het eindresultaat, dan bij de *ongepaarde t-toets*. Ondanks deze voordelen wordt er toch minder vaak vaak voor deze toets gekozen. Als de data wel normaal verdeeld zijn, heeft de *Mann-Whitney U toets* minder onderscheidend vermogen, dan de *ongepaarde t-toets*.[^2]
...
## De data bekijken
Gebruik `head()` om de eerste vijf regels te bekijken
...
```
<!-- ## /BLOK: Data-bekijken.R -->
Bekijk de grootte, mediaan en kwantielen van de data met `length()` en `quantile()`. 
...
[^4]: In dit voorbeeld wordt uitgegaan van een waarschijnlijkheid van 95% en c.q. een p-waardegrens van 0,05. De grens is naar eigen inzicht aan te passen, hou hierbij rekening met type I en type II fouten.

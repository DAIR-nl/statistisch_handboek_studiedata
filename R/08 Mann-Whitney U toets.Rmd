...
H~1~: Het behaalde aantal EC in het tweede jaar van internationale studenten is anders als van Nederlandse studenten.
</div>
...
# Uitvoering 
Er is data ingeladen met het aantal punten dat studenten in hun tweede jaar halen. `Punten_jaar2_NL` bevat Nederlandse studenten, `Punten_jaar2_inter` bevat internationale studenten. 
...
[^2]: Onderscheidend vermogen (Engels: power) is de kans dat de nulhypothese verworpen wordt wanneer de alternatieve hypothese 'waar' is.  

...
# Post-hoc toetsen
*Friedman's ANOVA* toetst of er verschillen zijn tussen de verdelingen van groepen. Voer een post-hoc toets uit om te bepalen welke groepen van elkaar verschillen. Gebruik de *Wilcoxon signed rank toets* als post-hoc toets.
...
<!-- ## TEKSTBLOK: posthoc5.R -->
* De beoordelingen van het hoofdgebouw verschillen niet significant van het bestuursgebouw (*p* = `r Round_and_format(posthoc[2,1])`, *r* = `r Round_and_format(Effectmaat_HG_BG)`), niet significant van het sportcentrum (*p* = `r Round_and_format(posthoc[3,3])`, *r* = `r Round_and_format(Effectmaat_HG_SC)`) en wel significant van het cultuurcentrum (*p* = `r Round_and_format(posthoc[2,2])`, *r* = `r Round_and_format(Effectmaat_HG_CC)`)
* De beoordelingen van het bestuursgebouw verschillen niet significant van het hoofdgebouw (*p* = `r Round_and_format(posthoc[2,1])`, *r* = `r Round_and_format(Effectmaat_HG_BG)`), niet significant van het sportcentrum (*p* = `r Round_and_format(posthoc[3,1])`, *r* = `r Round_and_format(Effectmaat_BG_SC)`) en niet significant van het cultuurcentrum (*p* = `r Round_and_format(posthoc[1,1])`, *r* = `r Round_and_format(Effectmaat_BG_CC)`)
* De beoordelingen van het sportcentrum verschillen niet significant van het hoofdgebouw (*p* = `r Round_and_format(posthoc[3,3])`, *r* = `r Round_and_format(Effectmaat_HG_SC)`), niet significant van het bestuursgebouw (*p* = `r Round_and_format(posthoc[3,1])`, *r* = `r Round_and_format(Effectmaat_BG_SC)`) en wel significant van het cultuurcentrum (*p* = `r Round_and_format(posthoc[3,2])`, *r* = `r Round_and_format(Effectmaat_SC_CC)`)
* De beoordelingen van het cultuurcentrum verschillen wel significant van het hoofdgebouw (*p* = `r Round_and_format(posthoc[2,2])`, *r* = `r Round_and_format(Effectmaat_HG_CC)`), niet significant van het bestuursgebouw (*p* = `r Round_and_format(posthoc[1,1])`, *r* = `r Round_and_format(Effectmaat_BG_CC)`) en wel significant van het sportcentrum (*p* = `r Round_and_format(posthoc[3,2])`, *r* = `r Round_and_format(Effectmaat_SC_CC)`)
...
[^11]: De effectmaat *r* wordt voor de *Wilcoxon signed rank toets* berekend door de

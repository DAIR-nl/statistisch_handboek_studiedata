...
*Friedman's ANVOA* is uitgevoerd om te onderzoeken of de beoordeling van eetgelegenheden door studenten verschilt voor vier gebouwen op de campus van een hogeschool. De vier gebouwen zijn het hoofdgebouw, het bestuursgebouw, het sportcentrum en cultuurcentrum Rembrandt; beschrijvende statistieken zijn te vinden in Tabel 1. De beoordelingen van de vier gebouwen verschillen significant van elkaar (&chi;^2^~3~ = `r vChi2`, *p* < 0,001, *W* = `r Round_and_format(W)`). De sterkte van het effect van de verschillen in gebouwen op de beoordelingen van studenten is gemiddeld. Post-hoc toetsen met een Bonferroni correctie voor meerdere toetsen zijn uitgevoerd voor alle vergelijkingen tussen twee gebouwen. Hieruit blijkt dat er alleen significante verschillen zijn tussen het hoofdgebouw (Mediaan = `r vMed_HG`) en cultuurcentrum Rembrandt (Mediaan = `r vMed_CC`), en tussen het sportcentrum (Mediaan = `r vMed_SC`) en cultuurcentrum Rembrandt (Mediaan = `r vMed_CC`). De eetgelegenheid van cultuurcentrum Rembrandt wordt dus slechter beoordeeld dan de eetgelegenheden in het hoofdgebouw en het sportcentrum; verder zijn er geen significante verschillen tussen de beoordelingen van de eetgelegenheden op de campus.
...
*Tabel 1. De mediaan, eerste en derde kwartiel en aantal observatie-eenheden voor de beoordelingen door studenten van de eetgelegenheden van de vier gebouwen op de campus van de hogeschool.*
<!-- ## /TEKSTBLOK: rapportage.R -->

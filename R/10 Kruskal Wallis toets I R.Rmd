...
Gebruik de [Mann-Whitney U toets](08-Mann-Whitney-U-toets-R.html) als post-hoc toets om te bepalen welke groepen significant verschillen. Gebruik de functie `pairwise.wilcox.test()` met als eerste argument de afhankelijke variabele `Resultaten_Arbeidsrecht$EC_Jaar1` en als tweede argument de definitie van de groepen `Resultaten_Arbeidsrecht$Vooropleiding`. Pas de *Bonferroni correctie* toe met `p.adjust.method = "bonferroni"`. Naast de p-waarde worden bij de [Mann-Whitney U toets](08-Mann-Whitney-U-toets-R.html) de gemiddelde rangschikkingen en de effectmaat *r* gerapporteerd. Voor meer informatie, zie de toetspagina van de [Mann-Whitney U toets](08-Mann-Whitney-U-toets-R.html).
<!-- ## /TEKSTBLOK: Mann-Whitney-U-test.R -->

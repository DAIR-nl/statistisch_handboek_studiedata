...
Gem_FR_NR <- Gemiddeld_rangnummer(Studiepunten_Fiscaal_Recht, Studiepunten_Notarieel_Recht)

Gem_FR_PM <- Gemiddeld_rangnummer(Studiepunten_Fiscaal_Recht, Studiepunten_Premaster)

Gem_FR_RG <- Gemiddeld_rangnummer(Studiepunten_Fiscaal_Recht, Studiepunten_Rechtsgeleerdheid)

Gem_NR_PM <- Gemiddeld_rangnummer(Studiepunten_Notarieel_Recht, Studiepunten_Premaster)

Gem_NR_RG <- Gemiddeld_rangnummer(Studiepunten_Notarieel_Recht, Studiepunten_Rechtsgeleerdheid)

Gem_PM_RG <- Gemiddeld_rangnummer(Studiepunten_Premaster, Studiepunten_Rechtsgeleerdheid)
...
Als voorbeeld wordt de bovenste rij van Tabel 1 in woorden uitgelegd. Er is geen significant verschil gevonden tussen Fiscaal (Gemiddeld rangnummer = `r Round_and_format(Gem_FR_NR[[1]])`,  *n*=`r vN_FIS`) Recht en Notarieel Recht (Gemiddeld rangnummer = `r Round_and_format(Gem_FR_NR[[2]])`,  *n*=`r vN_NOT`), *p*=1.
<!-- ## /TEKSTBLOK: Mann-Whitney-U-test3.R -->

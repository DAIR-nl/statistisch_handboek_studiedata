...
De mediaan van studenten met een vooropleiding Rechtsgeleerdheid heeft duidelijk minder studiepunten dan studenten met een vooropleiding Fiscaal Recht en Notarieel Recht. De mediaan van de studenten met de Premaster als vooropleiding ligt er tussen in.[^10]
...
<!-- ## CLOSEDBLOK: Kruskal-Wallis-test-3.R -->
...
```
<!-- ## /CLOSEDBLOK: Kruskal-Wallis-test-3.R -->
<!-- ## TEKSTBLOK: Kruskal-Wallis-test-4.R -->
* *df*: het aantal groepen - 1 = `r vK_DF`  
* *H*~3~ = `r vK_Chi2`, p < 0,0001  
...
[^10]: Bij niet normaal verdeelde data wordt de mediaan berekend in plaats van een gemiddelde om het midden van de data aan te geven. 
...
[^12]: Van Geloven, N. (13 maart 2018).  *Mann-Whitney U toets*. [Wiki Statistiek Academisch Medisch Centrum](https://wikistatistiek.amc.nl/index.php/Mann-Whitney_U_toets).

...
Gebruik de *Bonferroni correctie* om Type I fouten te voorkomen. Deze correctie past de p-waarde aan door de p-waarde te vermenigvuldigen met het aantal uitgevoerde toetsen.[^7]<sup>, </sup>[^8]
...
De mediaan van Rechtsgeleerdheid heeft duidelijk minder studiepunten dan Fiscaal Recht en Notarieel Recht. De Premaster ligt er tussen in.[^9]
...
* Er is een statistisch significant verschil gevonden tussen de Premaster (mediaan = `r vMed_PM`) en Notarieel Recht (mediaan = `r vMed_NOT`).   
...
* Er is ook geen statistisch significant verschil gevonden tussen Fiscaal Recht (mediaan = `r vMed_FIS`) en de Premaster (mediaan = `r vMed_PM`).
...
[^10]: In dit voorbeeld wordt uitgegaan van een waarschijnlijkheid van 95% en c.q. een p-waardegrens van 0,05. De grens is naar eigen inzicht aan te passen, houdt hierbij rekening met type I en type II fouten.

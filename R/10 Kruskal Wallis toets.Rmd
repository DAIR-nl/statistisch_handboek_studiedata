...
# Toepassing
Gebruik de *Kruskal Wallis toets* om te toetsen of de medianen van de groepen significant van elkaar verschillen.[^1] Een kenmerk van de data is dat deze numeriek en ongepaard is.  
...
* p-waarde < 0,05, dus de H~0~ wordt verworpen en de H~A~ wordt aangenomen[^7]

## Post-hoc toets: Mann-Whitney U toets
Gebruik de *Mann-Whitney U toets* als post-hoc toets om te bepalen wélke groepen significant verschillen. De *Mann-Whitney U toets* wordt ook wel de *Wilcoxon rank-sum toets* genoemd.[^8] Gebruik hierbij de `pairwise.wilcox.test()`. 
...
* Er is een statistisch significant verschil gevonden tussen de medianen van de pre-master (mediaan = `r vMed_PM`) en Notarieel Recht (mediaan = `r vMed_NOT`).   
* Er is geen statistisch significant verschil gevonden tussen de medianen van Fiscaal Recht (mediaan = `r vMed_FIS`) en Notarieel Recht (mediaan = `r vMed_NOT`).
* Er is ook geen statistisch significant verschil gevonden tussen de medianen van Fiscaal Recht (mediaan = `r vMed_FIS`) en de pre-master (mediaan = `r vMed_PM`).
...
[^1]: Bij normaal verdeelde data wordt het gemiddelde gebruikt om het midden van de data aan te geven. Daarentegen kan het gemiddelde sterk beïnvloed worden door extreme data zoals uitbijters. Daarom wordt bij niet normaal verdeelde data de mediaan vaak gebruikt om het midden van de data aan te geven. 
...
[^4]: Semi-continue: de data zijn discreet met zoveel optiemogelijkheden dat de data geanalyseerd kan worden alsof ze continu zijn. Van Geloven, N. (21 November 2017). *KEUZE TOETS*. [Wiki Statistiek Academisch Medisch Centrum](https://wikistatistiek.amc.nl/index.php/KEUZE_TOETS).
...
[^8]: van Geloven, N. (13 maart 2018).  *Mann-Whitney U toets*. [Wiki Statistiek Academisch Medisch Centrum](https://wikistatistiek.amc.nl/index.php/Mann-Whitney_U_toets).
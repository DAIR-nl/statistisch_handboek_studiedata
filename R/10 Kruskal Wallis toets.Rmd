...
[^1]: Bij normaal verdeelde data wordt het gemiddelde gebruikt om het midden van de data aan te geven. Daarentegen kan het gemiddelde sterk beïnvloed worden door extreme data zoals uitbijters. Daarom wordt bij niet normaal verdeelde data de mediaan gebruikt om het midden van de data aan te geven. 

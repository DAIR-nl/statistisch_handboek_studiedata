...
# Effectmaat
De p-waarde geeft aan of het verschil tussen groepen statistisch significant is. De grootte van het verschil of effect is echter ook relevant. Een effectmaat is een gestandaardiseerde maat die de grootte van een effect weergeeft zodat effecten vergeleken kunnen worden voor verschillende onderzoeken.[^5] 
...
De *McNemar toets* gebruikt een confusiematrix in plaats van een kruistabel. In een confusiematrix worden de aantallen studenten die wel of geen beroep op de FOS hebben gedaan tegen elkaar uitgezet voor december en juni. Sla daarom de variabele `FOS` apart op in twee vectoren, een voor december en een voor juni. Maak daarna de confusiematrix.
<!-- ## /TEKSTBLOK: Data-bekijken3.R -->
...
# Bereken proporties FOS voor juni en december
...
# Bereken verschil in proporties
...
# Bereken 95%-betrouwbaarheidsinterval
...
# Print interval
paste("Het verschil in proporties is",Round_and_format(Verschil_proporties),"met bijbehorend 95%-betrouwbaarheidsinterval van",
      Round_and_format(Betrouwbaarheidsinterval[1]),"tot", Round_and_format(Betrouwbaarheidsinterval[2]))
...
*Tabel 2. Kruistabel van aantal studenten dat beroep doet op FOS in december en juni*
...
Voer de exacte versie van de *McNemar toets* uit om te onderzoeken of er een verschil is tussen het percentage studenten dat een beroep doet op de FOS voor en na de interventie van de decaan. Bij een lage hoeveelheid observaties in de niet-diagonale elementen van de confusiematrix is deze toets nuttig om te gebruiken. Om deze toets te illustreren bij deze casus wordt een confusiematrix `EMN_confusiematrix` ingeladen waarbij de niet-diagonale elementen minder dan elf observaties bevatten.
<!-- ## /TEKSTBLOK: exMcNemar-toets1.R -->
...
Laad de bijbehorende kruistabel in om het aantal studenten dat wel of niet een beroep op de FOS doet te laten zien voor en na de interventie.
...
*Tabel 3. Kruistabel van aantal studenten dat beroep doet op FOS in december en juni*

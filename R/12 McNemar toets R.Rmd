...
De exacte versie van de *McNemar toets* wordt uitgevoerd om te onderzoeken of er een verschil is tussen het percentage studenten dat een beroep doet op de FOS voor en na de interventie van de decaan. Bij een lage hoeveelheid observaties in de niet-diagonale elementen van de confusiematrix is deze test nuttig om te gebruiken. Om deze test te illustreren bij deze casus wordt een confusiematrix `EMN_confusiematrix` ingeladen waarbij de niet-diagonale elementen minder dan elf observaties bevatten.
<!-- ## /TEKSTBLOK: exMcNemar-toets1.R -->

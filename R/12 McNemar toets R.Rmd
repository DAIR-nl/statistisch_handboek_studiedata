...
Er is een dataset ingeladen genaamd `Beroep_FOS_functiebeperking`. In deze dataset staat voor elke student aangegeven of ze wel of geen beroep op de FOS hebben gedaan in december en in juni. 
<!-- ## /TEKSTBLOK: Data-bekijken1.R -->
...
De kruistabel laat zien dat er het aantal studenten dat een beroep op de FOS heeft gedaan hoger is juni en het aantal studenten dat geen beroep op de FOS heeft gedaan lager is in juni. Het percentage studenten dat een beroep op de FOS heeft gedaan is dus toegenomen.
...
De *McNemar toets* is uitgevoerd om uit te vinden of er een verschil zit in het percentage studenten dat een beroep doet op de FOS voor en na de interventie van de decaan. De resultaten laten een significant verschil zien tussen de percentages voor en na de interventie ($\chi^2$~`r vdf`~ = `r vChi2`, *p* ≈ `r vp`), wat betekent dat de nulhypothese verworpen kan worden. De kruistabel laat zien dat het percentage studenten dat een beroep doet op de FOS is toegenomen na de interventie, de *McNemar toets* toont aan dat deze toename significant is. 
<!-- ## /TEKSTBLOK: McNemar-toets5.R -->
...
* p-waarde > 0,05, dus de H~0~ kan niet worden verworpen.[^5]
...
De exacte versie van de *McNemar toets* is uitgevoerd om uit te vinden of er een verschil zit in het percentage studenten dat een beroep doet op de FOS voor en na de interventie van de decaan. De resultaten laten geen significant verschil zien tussen de percentages voor en na de interventie (*p* = 1), dus de nulhypothese kan niet worden verworpen. Er is geen significant verschil tussen het percentage studenten dat een beroep op de FOS doet voor en na de interventie.
<!-- ## /TEKSTBLOK: McNemar-toets7.R -->

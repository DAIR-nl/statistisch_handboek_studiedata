...
Naast onbetrouwbaarheid bij geobserveerde waarden lager dan 10, wordt de *chi-kwadraat toets* ook onbetrouwbaar als één van de verwachte waarden 0 is. Verder wordt de toets onbetrouwbaar als in 20% van de verwachte waarde ≤ 5 is. 
...
<!-- ## CLOSEDBLOK: Fishers-Exact-toets -->
...
[^8]: In dit voorbeeld wordt uitgegaan van een waarschijnlijkheid van 95% en c.q. een p-waardegrens van 0,05. De grens is naar eigen inzicht aan te passen, houd hierbij rekening met type I en type II fouten.
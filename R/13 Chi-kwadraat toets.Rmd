...
## Celgrootte
Beide testen maken gebruik van een kruistabel; er zijn twee condities met in totaal vier mogelijke opties, zie tabel 1. voor een voorbeeld aan de hand van de casus. De *chi-kwadraat toets* berekent een verwachte waarde en vergelijkt deze met de geobserveerde waarde. Hieronder een uitleg met berekeningen van de verwachte waarde.  
...
*Tabel 2. Verwachte waarde casus uitval met of zonder leenstelsel*
 ...
 Berekening van de verwachte waarde van de groep uitgevallen studenten zonder leenstelsel.  
* totaal aantal studenten zonder leenstelsel: 871   
* totaal aantal studenten die uitgevallen zijn: 744  

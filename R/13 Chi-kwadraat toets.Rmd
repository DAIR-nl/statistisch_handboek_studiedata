...
## Celgrootte
Beide testen maken gebruik van een kruistabel, zie tabel 1 voor de geoberveerde waarden van de casus; De *Chi-kwadraat toets* heeft specifieke regels wat betreft de aantallen per cel. De test wordt onbetrouwbaar als in de cellen met de geobserveerde waarde 10 of lager staat.[^6]  
...
|**totaal**            |**744**   | **890**     | **1634** |
*Tabel 1. Geobserveerde waarde casus uitval met of zonder leenstelsel*

Op basis van geobserveerde waarden kan verwachte waarden berekend worden. 
...
* verwachte aantal uitgevallen studenten zonder leenstelsel: 871*744/1634 ≈ 397, zie tabel 2. 

...
*Cochran's Q toets* toetst of er verschillen zijn tussen een percentage op drie of meer herhaalde metingen. Voer een post-hoc toets uit om te bepalen welke metingen van elkaar verschillen. Gebruik de [McNemar toets](12-McNemar-toets-R.html) of de exacte [McNemar toets](12-McNemar-toets-R.html) als post-hoc toets.[^6]
...
* Er is een significant verschil tussen de vier onderwijsperiode wat betreft de verdeling van eerstejaars studenten van de bachelor Kunstmatige Intelligentie die geen herkansingen heeft of een of meer herkansingen hebben
...
Voer post-hoc toetsen uit om te onderzoeken tussen welke onderwijsperiodes er verschillen zijn in de verdeling van de eerstejaars studenten die wel of geen herkansingen hebben. Gebruik de [McNemar toets](12-McNemar-toets-R.html) of exacte [McNemar toets](12-McNemar-toets-R.html) als post-hoc toets. De exacte versie van de [McNemar toets](12-McNemar-toets-R.html) is nuttig om te gebruiken wanneer het aantal observaties in de niet-diagonale elementen van de confusiematrix kleiner dan 11 is. Een confusiematrix is een matrix waarin de rijen de ene meting en de kolommen de andere meting bevat. Voor meer informatie over de confusiematrix, zie de toetspagina van de [McNemar toets](12-McNemar-toets-R.html). 

Omdat er bij post-hoc toetsen vaak meerdere vergelijkingen gemaakt worden, is het tijdrovend om voor elke individuele vergelijking de confusiematrix te inspecteren. Voer daarom de [McNemar toets](12-McNemar-toets-R.html) en de exacte [McNemar toets](12-McNemar-toets-R.html) beide uit en vergelijk de significantie op beide toetsen. Wanneer een vergelijking op de ene toets significant is en op de andere toets niet significant, bepaal dan aan de hand van de confusiematrix welk toetsresultaat gebruikt moet worden.
...
[^11]: Met een observatie-eenheid wordt het object bedoeld dat geobserveerd wordt, bijvoorbeeld een student, een inwoner van Nederland, een opleiding of een organisatie. Met een observatie wordt de waarde bedoeld die de observatie-eenheid heeft voor een bepaalde variabele. Een observatie-eenheid heeft dus meestal een observatie voor meerdere variabelen. In de huidige casus zijn de studenten de observatie-eenheden en zijn er observaties voor het wel of niet maken van herkansingen voor alle vier de onderwijsperioden.

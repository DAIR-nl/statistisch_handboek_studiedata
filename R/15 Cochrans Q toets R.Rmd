...
*Cochran's Q toets* is te gebruiken wanneer het product van het aantal observatie-eenheden en het aantal herhaalde metingen groter dan of gelijk aan 24 is.[^4] Gebruik de exacte versie van *Cochran's Q toets* wanneer dit niet het geval is.[^5]
...
Een assumptie van *Cochran's Q toets* is dat het product van het aantal observatie-eenheden en het aantal herhaalde metingen groter dan of gelijk is aan 24. In deze casus gaat het om het product van het aantal eerstejaars studenten en het aantal onderwijsperiodes. Toets deze assumpties door dit product te berekenen.
...
Voer post-hoc toetsen uit om te onderzoeken tussen welke onderwijsperiodes er verschillen zijn in de verdeling van de eerstejaars studenten die wel of geen herkansingen hebben. Gebruik de [McNemar toets](12-McNemar-toets-R.html) of exacte [McNemar toets](12-McNemar-toets-R.html) als post-hoc toets. De exacte versie van de [McNemar toets](12-McNemar-toets-R.html) is nuttig om te gebruiken wanneer het aantal observaties in de niet-diagonale elementen van de frequentiematrix kleiner dan 11 is. Een frequentiematrix is een matrix waarin de rijen de ene meting en de kolommen de andere meting bevat. Voor meer informatie over de frequentiematrix, zie de toetspagina van de [McNemar toets](12-McNemar-toets-R.html). 

Omdat er bij post-hoc toetsen vaak meerdere vergelijkingen gemaakt worden, is het tijdrovend om voor elke individuele vergelijking de frequentiematrix te inspecteren. Voer daarom de [McNemar toets](12-McNemar-toets-R.html) en de exacte [McNemar toets](12-McNemar-toets-R.html) beide uit en vergelijk de significantie op beide toetsen. Wanneer een vergelijking op de ene toets significant is en op de andere toets niet significant, bepaal dan aan de hand van de frequentiematrix welk toetsresultaat gebruikt moet worden.
...
[^6]: De exacte [McNemar toets](12-McNemar-toets-R.html) wordt gebruikt wanneer het aantal observaties in de niet-diagonale elementen van de frequentiematrix kleiner dan 11 is. Voor meer informatie, zie de toetspagina van de [McNemar toets](12 McNemar toets R.Rmd).

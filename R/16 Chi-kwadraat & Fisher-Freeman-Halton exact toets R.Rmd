---
title: "16 Chi-kwadraat & Fisher-Freeman-Halton exact toets"
output:
  html_document:
    theme: lumen
    toc: yes
...
Er is een kruistabel (`Bsa_kt`) ingeladen over het BSA per instroomland van de faculteit Sociale Wetenschappen.
<!-- ## /TEKSTBLOK: Dataset-inladen.R-->

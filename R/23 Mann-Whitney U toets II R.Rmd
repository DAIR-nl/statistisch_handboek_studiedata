...
het aantal observaties, i.e. $\frac{z}{\sqrt{N}}$.[^5] Een correlatie tussen twee variabelen wordt vaak ook aangeduid met het symbool *r*, maar beide varianten van *r* hebben een verschillende betekenis.

# Uitvoering 
<!-- ## TEKSTBLOK: Dataset-inladen.R-->
Er is een dataset `Beoordelingen_gesprekstechnieken` ingeladen met het aantal studiepunten dat studenten in het tweede jaar halen.
<!-- ## /TEKSTBLOK: Dataset-inladen.R-->

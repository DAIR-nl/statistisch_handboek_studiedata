...
# Toepassing
Gebruik de *Kruskal Wallis toets* om te toetsen of twee of meer ongepaarde groepen van elkaar verschillen op een ordinale variabele.[^17]<sup>, </sup>[^1] Een alternatief voor een vergelijking van twee of meer groepen op een ordinale variabele is de *chi-kwadraat toets voor onafhankelijkheid* of de *Fisher-Freeman-Halton exact toets* (bij een laag aantal observaties). Bij deze toetsen wordt echter geen rekening gehouden met de ordening van de categorieën van de ordinale variabele: de variabele wordt behandeld als een nominale variabele.
...
Het meetniveau van de afhankelijke variabele is ordinaal[^16] of continu.[^17] In deze toetspagina staat een casus met ordinale data centraal; een casus met continue data is te vinden in [een andere toetspagina](10-Kruskal-Wallis-toets-I-R.html). 

# Post-hoc toets 
De *Kruskal Wallis toets* toetst of twee of meerdere groepen van elkaar verschillen. Een post-hoc toets specificeert of groep significant van een andere groep verschilt. Gebruik de [Mann-Whitney U toets](23-Mann-Whitney-U-toets-II-R.html) als post-hoc toets.
...
De kruistabel en bijbehorende kruistabel met proporties geven informatie over de verdeling van de beoordelingen van studenten. Bij Economics en Finance krijgen de meeste studenten een voldoende als beoordeling. Bij Entrepeneurship worden de presentatievaardigheden van studenten het meest als goed beoordeeld en bij Marketing het meest als uitstekend.
...
``` {r pairwise wilcox test closed, warning = FALSE}

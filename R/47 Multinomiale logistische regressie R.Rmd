...
Merk hierbij op dat de referentiecategorie gekozen wordt door de onderzoeker en dat de vergelijkingen dus veranderen bij de keuze voor een andere referentiecategorie.
...
Er is sprake van een onderdispersie, aangezien de dispersieparameter (`r Round_and_formatDisp)`) kleiner dan 1 is. Het verschil met 1 is echter niet zeer klein en bij onderdispersie wordt er in het algemeen geen correctie uitgevoerd. Voor de *multinomiale logistische regressie* in deze casus wordt daarom geen correctie uitgevoerd vanwege onderdispersie.
<!-- ## /TEKSTBLOK: Dispersie4.R -->

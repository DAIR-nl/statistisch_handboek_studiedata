...
Bepaalde toetsen bevatten de assumptie dat data normaal verdeeld zijn. Dit kan ingeschat worden door naar een histogram, QQ-plot of boxplot te kijken en kan worden getoetst door normaliteitstoetsen. Bij een groepsgrootte van *n* > 100 kan er vanuit gegaan worden dat per groep de data zich normaal gedraagt.[^3] 
